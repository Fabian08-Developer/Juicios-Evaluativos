...
<div class="card" style="max-width: 700px; margin: 0 auto; padding: 3rem;">
    <div style="text-align: center; margin-bottom: 3rem;">
        ...
        <h2 style="font-size: 1.75rem; font-weight: 800; color: #fff; margin-bottom: 0.5rem;">Editar Ficha {{ $ficha->Id_Ficha }}</h2>
        <p style="color: var(--text-muted); font-size: 0.95rem;">Actualiza la información del grupo de formación</p>
    </div>
    ...
    <form action="{{ route('fichas.update', $ficha->Id_Ficha) }}" method="POST">
        ...
        <div style="display: flex; gap: 1rem;">
            ...
            <button type="submit" class="btn btn-primary" style="flex: 2; justify-content: center; padding: 1rem;">
                <i class="fa-solid fa-sync"></i> Actualizar Ficha
            </button>
        </div>
    </form>
</div>
